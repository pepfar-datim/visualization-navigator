...
const DestructiveSelectOption = _ref => {
  ...
  }, ["div.__jsx-style-dynamic-selector{cursor:pointer;font-size:14px;-webkit-text-decoration:none;text-decoration:none;color:".concat(_uiConstants.colors.red700, ";padding:").concat(_uiConstants.spacers.dp8, " ").concat(_uiConstants.spacers.dp12, ";}"), "div.__jsx-style-dynamic-selector:hover{background-color:".concat(_uiConstants.colors.red050, ";}")]));
};
