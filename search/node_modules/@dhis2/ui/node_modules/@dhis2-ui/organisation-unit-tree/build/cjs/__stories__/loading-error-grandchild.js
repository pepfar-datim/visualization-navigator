...
exports.LoadingErrorGrandchild = void 0;
...
const LoadingErrorGrandchild = () => /*#__PURE__*/_react.default.createElement(_appRuntime.CustomDataProvider, {
  data: { ..._shared.customData,
    organisationUnits: function () {
      ...
      return _shared.customData.organisationUnits(...args);
    }
  }
  ...
  onExpand: _shared.onExpand,
  onCollapse: _shared.onCollapse,
  onChildrenLoaded: _shared.onChildrenLoaded,
