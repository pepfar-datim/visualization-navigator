 ...
 */
(0, _steps.Given)('a sharing dialog that allows adding user entities is visible', () => {
...
(0, _steps.Given)('a sharing dialog that allows adding group entities is visible', () => {
  cy.intercept('GET', '/api/38/sharing?type=visualization&id=id', {
    body: _index.noAccess
  });
  cy.visitStory('sharing-dialog', 'visualization');
...
(0, _steps.When)('the user gives user view only access', () => {
...
(0, _steps.When)('the user gives user view and edit access', () => {
  cy.intercept('GET', '/api/38/sharing/search?key=A%20user', {
    body: _index.searchUser
  });
  cy.get('[placeholder="Search"]').type('A user');
...
(0, _steps.When)('the user gives group view only access', () => {
...
(0, _steps.When)('the user gives group view and edit access', () => {
  cy.intercept('GET', '/api/38/sharing/search?key=A%20group', {
    body: _index.searchGroup
  });
  cy.get('[placeholder="Search"]').type('A group');
...
(0, _steps.Then)('the user should be added to the access list with view only access', () => {
...
(0, _steps.Then)('the user should be added to the access list with view and edit access', () => {
  cy.contains('.wrapper', 'A user').should('be.visible').as('user-item');
  cy.get('@user-item').contains('Can view and edit').should('be.visible');
  cy.get('@user-item').contains('View and edit').should('be.visible');
});
(0, _steps.Then)('the group should be added to the access list with view only access', () => {
...
(0, _steps.Then)('the group should be added to the access list with view and edit access', () => {
  cy.contains('.wrapper', 'A group').should('be.visible').as('group-item');
  cy.get('@group-item').contains('Can view and edit').should('be.visible');
  cy.get('@group-item').contains('View and edit').should('be.visible');
});
(0, _steps.Then)('the autocomplete input should be cleared', () => {
