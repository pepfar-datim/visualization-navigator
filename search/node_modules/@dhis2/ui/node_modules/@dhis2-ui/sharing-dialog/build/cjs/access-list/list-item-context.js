...
exports.ListItemContext = void 0;
...
const ListItemContext = _ref => {
  ...
  switch (access) {
    case _constants.ACCESS_NONE:
      message = _index.default.t('No access');
      break;

    case _constants.ACCESS_VIEW_ONLY:
      message = _index.default.t('Can view');
      break;

    case _constants.ACCESS_VIEW_AND_EDIT:
      message = _index.default.t('Can view and edit');
      break;
  ...
  return /*#__PURE__*/_react.default.createElement("p", {
    className: _style.default.dynamic([["2525483302", [_uiConstants.colors.grey700]]])
  }, message, /*#__PURE__*/_react.default.createElement(_style.default, {
    id: "2525483302",
    dynamic: [_uiConstants.colors.grey700]
  }, ["p.__jsx-style-dynamic-selector{font-size:14px;color:".concat(_uiConstants.colors.grey700, ";margin:6px 0 0 0;padding:0;}")]));
};
