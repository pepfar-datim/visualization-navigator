...
const customData = { ...customDefaultData,
  sharing: { ...customDefaultData.sharing,
    object: { ...customDefaultData.sharing.object,
      name: 'Sharing test',
      displayName: "Sharing dialog's test"
    }
  }
};
const customDataDisabledAccess = { ...customData,
  sharing: { ...customData.sharing,
    meta: {
...
const customDataWithUserGroupAccesses = { ...customData,
  sharing: { ...customData.sharing,
    object: { ...customData.sharing.object,
      userAccesses: [{
        id: 'user-1',
        name: 'Kvist',
        access: 'rw------'
...
const dashboardData = { ...customDataWithUserGroupAccesses,
  dashboards: {
    dashboardItems: [{
      type: 'TEXT'
    }, {
...
const dashboardDataWithPublicAccess = { ...dashboardData,
  sharing: { ...customData.sharing,
    object: { ...customData.sharing.object,
      publicAccess: 'r-------'
    }
...
export const Simple = args => /*#__PURE__*/React.createElement(CustomDataProvider, {
  data: customDefaultData
}, /*#__PURE__*/React.createElement(SharingDialog, args)); // Have this be the primary story on the docs page
...
export const WithName = args => /*#__PURE__*/React.createElement(CustomDataProvider, {
  data: customData
}, /*#__PURE__*/React.createElement(SharingDialog, args));
WithName.storyName = 'With name';
export const WithDisabledAccess = args => /*#__PURE__*/React.createElement(CustomDataProvider, {
  data: customDataDisabledAccess
}, /*#__PURE__*/React.createElement(SharingDialog, args));
WithDisabledAccess.storyName = 'With disabled access';
export const WithUserAndGroupAccesses = args => /*#__PURE__*/React.createElement(CustomDataProvider, {
  data: customDataWithUserGroupAccesses
}, /*#__PURE__*/React.createElement(SharingDialog, args));
WithUserAndGroupAccesses.storyName = 'With user and group accesses';
export const ForDashboard = args => /*#__PURE__*/React.createElement(CustomDataProvider, {
  data: dashboardData
}, /*#__PURE__*/React.createElement(SharingDialog, args));
...
export const ForDashboardWithPublicAccess = args => /*#__PURE__*/React.createElement(CustomDataProvider, {
...
export const ForDashboardWithCascadeSharingSuccess = args => /*#__PURE__*/React.createElement(CustomDataProvider, {
  data: { ...dashboardData,
...
export const ForDashboardWithCascadeSharingPartialSuccess = args => /*#__PURE__*/React.createElement(CustomDataProvider, {
  data: { ...dashboardData,
