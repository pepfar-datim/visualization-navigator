...
import { Tooltip } from './tooltip.js'; // Due to its global nature, tooltip & popper need to be unmounted after each test
...
describe('it handles custom open and close delays', () => {
  it('handles open delay = close delay = 0', () => {
    ...
    wrapper.simulate('mouseover'); // wait for open delay (necessary b/c timeout is still used)
    ...
    wrapper.simulate('mouseout'); // wait for close delay (necessary b/c timeout is used)
  ...
  it('handles open delay = close delay = 1000', () => {
    ...
    wrapper.simulate('mouseover'); // expect tooltip is not open after 950ms
    ...
    wrapper.simulate('mouseout'); // expect tooltip to still be open after 950ms
