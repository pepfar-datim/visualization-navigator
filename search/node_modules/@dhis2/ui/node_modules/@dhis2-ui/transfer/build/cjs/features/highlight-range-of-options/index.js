...
(0, _steps.Given)('the option list has one or more items', () => {
...
(0, _steps.Given)('the selected list has one or more items', () => {
...
(0, _steps.Given)('no item is highlighted', () => {
  cy.get('@list').find('.highlighted').should('not.exist');
});
(0, _steps.Given)('one item is highlighted', () => {
  cy.get('@list').find('{transferoption}').first().as('initiallyHighlighted').click().should('have.class', 'highlighted');
});
(0, _steps.Given)('there are at least two options following the highlighted option', () => {
...
(0, _steps.Given)('several options are highlighted', () => {
...
(0, _steps.Given)('there are at least two options following the last highlighted option', () => {
...
(0, _steps.When)('the user clicks an item with the SHIFT modifier key', () => {
  cy.get('@list').find('{transferoption}').first().clickWith('ctrl').as('initiallyHighlighted');
});
(0, _steps.When)('the user clicks the highlighted item with the SHIFT modifier key', () => {
  cy.get('@initiallyHighlighted').clickWith('shift').as('hiddenHighlighted');
});
(0, _steps.When)('the user highlightes the second options following the highlighted option with the SHIFT key modifier', () => {
  cy.get('@secondBelowInitiallyHighlighted').clickWith('shift');
});
(0, _steps.When)('the user highlightes the second options following the last highlighted option', () => {
...
(0, _steps.Then)('all options between the initially highlighted option and the clicked option are highlighted', () => {
  cy.get('@firstBelowInitiallyHighlighted').should('have.class', 'highlighted');
});
(0, _steps.Then)('the option highlighted most recently without SHIFT should be highlighted', () => {
  cy.get('@initiallyHighlightedMultiple').last().should('have.class', 'highlighted');
});
(0, _steps.Then)('the option clicked with SHIFT should be highlighted', () => {
  cy.get('@secondBelowInitiallyHighlighted').should('have.class', 'highlighted');
});
(0, _steps.Then)('all options between the option highlighted most recently without SHIFT and the clicked option are highlighted', () => {
  cy.get('@firstBelowInitiallyHighlighted').should('have.class', 'highlighted');
});
