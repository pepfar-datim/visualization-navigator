...
<head>
    <title>Code coverage report for modules/text.utils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">modules</a> text.utils.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5x</span></td><td class="text"><pre class="prettyprint lang-js">import {screen} from "@testing-library/react";
&nbsp;
/**
