...
(0, _steps.Given)('there is enough space below the anchor to fit the SingleSelect menu', () => {
  cy.visitStory('SingleSelect', 'Default position');
});
(0, _steps.Given)('there is not enough space below the anchor to fit the SingleSelect menu', () => {
  cy.visitStory('SingleSelect', 'Flipped position');
});
(0, _steps.Given)('there is not enough space above or below the anchor to fit the SingleSelect menu', () => {
  cy.visitStory('SingleSelect', 'Shifted into view');
});
(0, _steps.When)('the SingleSelect is clicked', () => {
