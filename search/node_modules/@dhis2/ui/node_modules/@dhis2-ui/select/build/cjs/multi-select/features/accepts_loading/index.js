...
(0, _steps.Given)('a MultiSelect with options and a loading flag is rendered', () => {
  cy.visitStory('MultiSelect', 'With options and loading');
});
(0, _steps.Given)('a MultiSelect with options, a loading flag and a loading text is rendered', () => {
