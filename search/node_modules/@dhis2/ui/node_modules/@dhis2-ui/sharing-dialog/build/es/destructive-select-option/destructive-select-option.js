...
export const DestructiveSelectOption = _ref => {
  ...
  }, ["div.__jsx-style-dynamic-selector{cursor:pointer;font-size:14px;-webkit-text-decoration:none;text-decoration:none;color:".concat(colors.red700, ";padding:").concat(spacers.dp8, " ").concat(spacers.dp12, ";}"), "div.__jsx-style-dynamic-selector:hover{background-color:".concat(colors.red050, ";}")]));
};
