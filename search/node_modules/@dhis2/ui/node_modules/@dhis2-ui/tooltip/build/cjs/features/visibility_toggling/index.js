...
(0, _steps.When)('the mouse cursor leaves the anchor', () => {
...
(0, _steps.Then)('the Tooltip is not rendered', () => {
  cy.get('[data-test="dhis2-uicore-tooltip-content"]').should('not.exist');
});
(0, _steps.When)('there is a short pauze', () => {
  cy.clock(); // Shorter than the components CLOSE_DELAY
