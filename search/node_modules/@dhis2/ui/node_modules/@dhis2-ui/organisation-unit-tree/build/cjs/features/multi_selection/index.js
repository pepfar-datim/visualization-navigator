...
(0, _steps.Given)('an OrganisationUnitTree with two levels is rendered', () => {
...
(0, _steps.Given)('the root level unit is opened', () => {
  cy.getOrgUnitByLabel('Org Unit 1').openOrgUnitNode(true);
});
(0, _steps.Given)('the first unit on the second level is selected', () => {
  cy.getOrgUnitByLabel('Org Unit 2').toggleOrgUnitNodeSelection(true);
});
(0, _steps.Given)('the first unit on the second level unit is opened', () => {
  cy.getOrgUnitByLabel('Org Unit 2').openOrgUnitNode(true);
});
(0, _steps.Given)('the second level has two units', () => {
...
(0, _steps.When)('the user selects a unit', () => {
  cy.getOrgUnitByLabel('Org Unit 1').toggleOrgUnitNodeSelection(true);
});
(0, _steps.When)('the user selects the first unit on the second level', () => {
  cy.getOrgUnitByLabel('Org Unit 2').toggleOrgUnitNodeSelection(true);
});
(0, _steps.When)('the user selects the root level', () => {
  cy.getOrgUnitByLabel('Org Unit 1').toggleOrgUnitNodeSelection(true);
});
(0, _steps.When)('the user selects the second unit on the second level', () => {
  cy.getOrgUnitByLabel('Org Unit 3').toggleOrgUnitNodeSelection(true);
});
(0, _steps.Then)('a unit is selected', () => {
  cy.window().should(win => {
    expect(win.selection).to.eql(['/A0000000000']);
  });
});
(0, _steps.Then)('the unit on the second level is selected', () => {
  cy.window().should(win => {
    expect(win.selection).to.eql(['/A0000000000/A0000000001']);
  });
});
(0, _steps.Then)('the unit on the first level is marked as selected intermediately', () => {
...
(0, _steps.Then)('the root unit is marked as selected', () => {
  cy.window().should(win => {
