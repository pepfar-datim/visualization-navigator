...
(0, _steps.Given)('a sharing dialog with user item with view and edit is visible', () => {
  cy.intercept('GET', '/api/38/sharing?type=visualization&id=id', {
...
(0, _steps.Given)('a sharing dialog with group item with view and edit is visible', () => {
  cy.intercept('GET', '/api/38/sharing?type=visualization&id=id', {
...
(0, _steps.When)('the user removes the access for the user', () => {
  ...
  cy.contains('Remove access').should('be.visible').click(); // Menu should be closed before continuing

  cy.get('[data-test="dhis2-uicore-select-menu-menuwrapper"]').should('not.exist');
});
(0, _steps.When)('the user removes the access for the group', () => {
  cy.intercept('PUT', '/api/38/sharing?type=visualization&id=id', req => {
    const expected = {
...
(0, _steps.Then)('the user item should be removed', () => {
  cy.contains('.details-text', 'A user').should('not.exist');
});
(0, _steps.Then)('the group item should be removed', () => {
