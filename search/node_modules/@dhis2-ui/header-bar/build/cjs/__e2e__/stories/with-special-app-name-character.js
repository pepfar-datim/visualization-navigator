...
WithSpecialAppNameCharacters.decorators = [(0, _common.createDecoratorCustomDataProviderHeaderBar)({ ..._common.dataProviderData,
  ['action::menu/getModules']: { ..._common.dataProviderData['action::menu/getModules'],
