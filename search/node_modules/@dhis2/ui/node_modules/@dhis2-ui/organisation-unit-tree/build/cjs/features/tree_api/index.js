...
(0, _steps.Given)('an OrganisationUnitTree is rendered', () => {
  cy.visitStory('OrganisationUnitTree', 'Events');
  cy.getOrgUnitByLabel('Org Unit 1').shouldBeDoneLoading();
});
(0, _steps.Given)('a node has been selected', () => {
  cy.getOrgUnitByLabel('Org Unit 1').toggleOrgUnitNodeSelection(true);
});
(0, _steps.Given)('a node with children is rendered', () => {
  cy.visitStory('OrganisationUnitTree', 'Events');
});
(0, _steps.Given)('the node has been expanded', () => {
  cy.getOrgUnitByLabel('Org Unit 1').openOrgUnitNode();
});
(0, _steps.Given)("the children haven't been loaded yet", () => {
  cy.window().should(win => {
    expect(win.onExpand).not.to.be.called;
  });
});
(0, _steps.When)('a node gets selected', () => {
  cy.getOrgUnitByLabel('Org Unit 1').toggleOrgUnitNodeSelection(true);
});
(0, _steps.When)('a node gets deselected', () => {
  cy.getOrgUnitByLabel('Org Unit 1').toggleOrgUnitNodeSelection(false);
});
(0, _steps.When)('the node is expanded', () => {
  cy.getOrgUnitByLabel('Org Unit 1').openOrgUnitNode();
});
(0, _steps.When)('a node is collapsed', () => {
  cy.getOrgUnitByLabel('Org Unit 1').closeOrgUnitNode();
});
(0, _steps.When)('the children have been loaded', () => {
  cy.getOrgUnitByLabel('Org Unit 1').toggleOrgUnitNode(true);
});
(0, _steps.Then)('the onChange callback gets called', () => {
  cy.window().should(win => {
    expect(win.onChange).to.be.called;
  });
});
(0, _steps.Then)('the payload includes the path of the selected node', () => {
  cy.window().should(win => {
    expectStubPayloadToEqual(win.onChange, 'path', '/A0000000000');
  });
});
(0, _steps.Then)('the payload includes checked which is set to "true"', () => {
  cy.window().should(win => {
    expectStubPayloadToEqual(win.onChange, 'checked', true);
  });
});
(0, _steps.Then)('the payload includes all selected nodes', () => {
  cy.window().should(win => {
    expectStubPayloadToEqual(win.onChange, 'selected', ['/A0000000000']);
  });
});
(0, _steps.Then)('the payload includes checked which is set to "false"', () => {
  cy.window().should(win => {
    expectStubPayloadToEqual(win.onChange, 'checked', false);
  });
});
(0, _steps.Then)('the onExpand callback gets called', () => {
  cy.window().should(win => {
    expect(win.onExpand).to.be.called;
  });
});
(0, _steps.Then)('the payload includes the path of the expanded node', () => {
  cy.window().should(win => {
    expectStubPayloadToEqual(win.onExpand, 'path', '/A0000000000');
  });
});
(0, _steps.Then)('the onCollapse callback gets called', () => {
  cy.window().should(win => {
    expect(win.onCollapse).to.be.called;
  });
});
(0, _steps.Then)('the payload includes the path of the collapsed node', () => {
  cy.window().should(win => {
    expectStubPayloadToEqual(win.onCollapse, 'path', '/A0000000000');
  });
});
(0, _steps.Then)('the onChildrenLoaded callback gets called', () => {
  cy.window().should(win => {
