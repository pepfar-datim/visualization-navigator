...
describe('validator: email', () => {
  ...
  describe('allows valid email addresses', () => {
     ...
     */
    (0, _index.testValidatorValues)(_email.email, undefined, ['email@example.com', 'firstname.lastname@example.com', 'email@subdomain.example.com', 'firstname+lastname@example.com', // 'email@123.123.123.123',
