 ...
 */
(0, _steps.Given)('a sharing dialog with all users item with no access is visible', () => {
...
(0, _steps.Given)('a sharing dialog with user item with view is visible', () => {
  cy.intercept('GET', '/api/38/sharing?type=visualization&id=id', {
...
(0, _steps.Given)('a sharing dialog with group item with view is visible', () => {
  cy.intercept('GET', '/api/38/sharing?type=visualization&id=id', {
...
(0, _steps.When)('the user sets the all users access level to view only', () => {
  ...
  cy.contains('[data-test="dhis2-uicore-select-menu-menuwrapper"] [data-test="dhis2-uicore-singleselectoption"]', 'View only').should('be.visible').click(); // Menu should be closed before continuing

  cy.get('[data-test="dhis2-uicore-select-menu-menuwrapper"]').should('not.exist');
});
(0, _steps.When)('the user sets the all users access level to view and edit', () => {
  cy.intercept('PUT', '/api/38/sharing?type=visualization&id=id', req => {
    const expected = {
  ...
  cy.get('@all-users-list-item').find('[data-test="dhis2-uicore-singleselect"]').click();
  cy.contains('[data-test="dhis2-uicore-select-menu-menuwrapper"] [data-test="dhis2-uicore-singleselectoption"]', 'View and edit').should('be.visible').click(); // Menu should be closed before continuing

  cy.get('[data-test="dhis2-uicore-select-menu-menuwrapper"]').should('not.exist');
});
(0, _steps.When)('the user sets the user access level to view and edit', () => {
  cy.intercept('PUT', '/api/38/sharing?type=visualization&id=id', req => {
    const expected = {
...
(0, _steps.When)('the user sets the group access level to view and edit', () => {
  cy.intercept('PUT', '/api/38/sharing?type=visualization&id=id', req => {
    const expected = {
...
(0, _steps.Then)('the all users section should be labeled for view only', () => {
  cy.get('@all-users-list-item').contains('.details-text', 'Can view').should('be.visible');
});
(0, _steps.Then)('the all users section should be labeled for view and edit', () => {
  cy.get('@all-users-list-item').contains('.details-text', 'Can view and edit').should('be.visible');
});
(0, _steps.Then)('the user section should be labeled for view and edit', () => {
  cy.get('@user-list-item').contains('.details-text', 'Can view and edit').should('be.visible');
});
(0, _steps.Then)('the group section should be labeled for view and edit', () => {
