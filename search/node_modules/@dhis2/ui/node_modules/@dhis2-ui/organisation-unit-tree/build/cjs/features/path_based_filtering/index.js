...
(0, _steps.Given)('a unfiltered OrganisationUnitTree with a depth of 3 levels is rendered', () => {
  cy.visitStory('OrganisationUnitTree', 'Filtered by 3-level-path');
});
(0, _steps.Given)('a filtered OrganisationUnitTree with a depth of 3 levels is rendered', () => {
...
(0, _steps.Given)('the second level contains two nodes', () => {});
(0, _steps.Given)('all parent levels are open', () => {});
(0, _steps.Given)('a filter containing the first child of the first second level is provided', () => {});
(0, _steps.Given)('the second level nodes each have a child node', () => {});
(0, _steps.Given)('a filter containing the first child of the second level is provided', () => {});
(0, _steps.Given)('a filter containing the second child of the first level is provided', () => {});
(0, _steps.Then)('the root level is visible', () => {
  cy.getOrgUnitByLabel('Org Unit 1').should('exist');
  addDisplayedUnit('A0000000000');
});
(0, _steps.Then)('the first node on the second level is visible', () => {
  cy.getOrgUnitByLabel('Org Unit 2').should('exist');
  addDisplayedUnit('A0000000001');
});
(0, _steps.Then)('the first child node of the first node on the second level is visible', () => {
  cy.getOrgUnitByLabel('Org Unit 4').should('exist');
  addDisplayedUnit('A0000000003');
});
(0, _steps.Then)('the second node on the first level is visible', () => {
  cy.getOrgUnitByLabel('Org Unit 3').should('exist');
  addDisplayedUnit('A0000000002');
});
(0, _steps.Then)('all other nodes are not rendered', async () => {
  cy.get('@displayedUnits').then(displayedUnits => {
    cy.window().then(win => {
