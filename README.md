...
1. [Install the app via the App Hub](https://apps.dhis2.org/app/47c2f9ae-6a8a-4534-b41d-84cd567fcc04) or by uploading into the DHIS2 App Management app the zip either from [our releases](https://github.com/pepfar-datim/visualization-navigator/releases) or from `npm run build`
