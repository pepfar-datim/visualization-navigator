...
const StandardForm = _ref => {
  ...
  }), values.subscribe && /*#__PURE__*/_react2.default.createElement(_reactFinalForm.Field, {
  ...
  }), /*#__PURE__*/_react2.default.createElement(_FieldGroupFF.FieldGroupFF, {
    name: "food",
    label: "Food",
    required: true,
...
(0, _react.storiesOf)('Testing:FileInput', module).addDecorator(_formDecorator.formDecorator).addParameters({
  options: {
    showPanel: false
  }
