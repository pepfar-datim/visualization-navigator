...
const Menu = _ref2 => {
  ...
  const children = _react.default.Children.map(options, child => {
    const isValidOption = (0, _index.checkIfValidOption)(child); // Return early if the child isn't an option, to prevent attaching handlers etc.
    ...
    const isActive = !!(0, _index.findOption)(value, selected); // Create the appropriate click handler for the option
